        ...
        <div class="row removable">
            <div class="col-lg-4">
                <div class="card card-profile">
                    <img src="https://demos.creative-tim.com/argon-dashboard/assets-old/img/theme/img-1-1000x600.jpg"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="chart">
                            ...
                            <canvas id="chart-bars" class="chart-canvas chartjs-render-monitor" width="1348"
                                height="700" style="display: block; height: 350px; width: 674px;"></canvas>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <span class="h2 font-weight-bold mb-0">10,442</span>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <span class="h2 font-weight-bold mb-0">140</span>
                            </div>
                            <div class="col-auto">
                        ...
                        <p class="mt-3 mb-0 text-sm">
                            <span class="text-success mr-2"><i class="fa fa-arrow-up"></i>&nbsp;5.8%</span>
